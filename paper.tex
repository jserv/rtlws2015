...
\hline
\multirow{2}{*}{} & \multicolumn{3}{c|}{user} & \multicolumn{3}{c|}{kernel} & \multicolumn{3}{c|}{timer-irq} \\ \cline{2-10} 
 & min & \multicolumn{1}{c|}{avg} & \multicolumn{1}{c|}{max} & min & \multicolumn{1}{c|}{avg} & \multicolumn{1}{c|}{max} & min & \multicolumn{1}{c|}{avg} & \multicolumn{1}{c|}{max} \\ \hline
Xenomai 2 & \multicolumn{1}{r|}{8.541} & 9.458 & 34.583 & \multicolumn{1}{r|}{6.965} & 7.708 & 27.821 & \multicolumn{1}{r|}{2.129} & 2.654 & 11.343 \\ \hline
Xenomai 3 & \multicolumn{1}{r|}{8.043} & 8.853 & 33.023 & \multicolumn{1}{r|}{5.567} & 6.479 & 25.577 & \multicolumn{1}{r|}{2.586} & 3.079 & 10.031 \\ \hline
\end{tabular}
}
