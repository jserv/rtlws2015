...
Four distinct Linux kernel configurations are used for the experiments, as summarized in table below \ref{table:config}. Kernel are patched using git merge first, and remaining conflicts are resolved manually.
